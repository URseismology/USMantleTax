function [m, errors] = sparse_inverse_radon_fista_synthetic(d, dt, rayP, q, ...
    flow, fhigh, reg_param, reg_param2, maxiter, gt)
%%SPARSE_INVERSE_RADON_FISTA_SYNTHETIC Calculates SRTFISTA-based 
%%reconstruction on synthetic data
%
% Inputs:
%       d:         seismic traces
%       dt:        sampling in sec
...
%     end
    ...
    errors(kstep+1) = sum(abs(m-gt),"all");
