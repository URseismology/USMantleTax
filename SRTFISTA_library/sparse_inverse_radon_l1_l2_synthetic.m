function [m, errors] = sparse_inverse_radon_l1_l2_synthetic(d, dt, rayP, q, ...
    flow, fhigh, mu, alpha, lambd, rho, maxiter, gt)
%%SPARSE_INVERSE_RADON_L1_L2_SYNTHETIC Calculates SRTL1-2-based 
